...
/**
 * Servlet implementation class DeleteTheaterScreen
 */
@WebServlet("/DeleteTheaterScreen")
public class DeleteTheaterScreen extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DeleteTheaterScreen() {
        super();
